  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.7s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "fade-in-up": "fade-in-up 0.7s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "fade-in-up-subtle": "fade-in-up-subtle 0.6s cubic-bezier(0.4, 0, 0.2, 1)",
        "fade-in-down": "fade-in-down 0.7s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "fade-in-left": "fade-in-left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "fade-in-right": "fade-in-right 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "scale-in": "scale-in 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "scale-in-bounce": "scale-in-bounce 0.7s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "pop-in": "pop-in 0.65s cubic-bezier(0.34, 1.56, 0.64, 1)",
